...
namespace DPSOsTelemetria.Pozos.PozoBombeoMecanico
{
    public partial class TomaInformacion : UserControl
    {
        ...
        public TomaInformacion(int _decimales, ReferenciasII referencias) : this()
        {
            ...
            CargaSobreBarraPulidaMin.Text = Condicionantes.Wrote_Formating(referencias.Range.CargaSobreBarraPulidaMin.ToString(), decimales);
            CargaSobreBarraPulidaMax.Text = Condicionantes.Wrote_Formating(referencias.Range.CargaSobreBarraPulidaMax.ToString(), decimales);
        ...
        internal void Recargar(int _decimales)
        {
            ...
            CargaSobreBarraPulidaMin.Text = Condicionantes.Wrote_Formating(CargaSobreBarraPulidaMin.Text,decimales);
            CargaSobreBarraPulidaMax.Text = Condicionantes.Wrote_Formating(CargaSobreBarraPulidaMax.Text,decimales);
